...
\addbibresource{computer-experts.bib}
...
%% How about: "When anthropologists and digital experts meet?" 
...
\begin{quote}
  ...
  flawed. Another member soon after responded saying that he was offended by
...
in order to become the technologist they aspire to be. Another important
characteristic of this exchange is the fact that objectification fall
very short of any attempt of creating an ethical relationship with
research subjects. One particularly fruitful mode of engagemet was
describe by Michael Fortun under the guise of "friendship with the 
sciences" \cite{Fortun2005} which is an important mode for the ethnographic study of
computing cultures as well.
...
Another way to put this is one must be willing to defend the 
relevance of one's research vis-a-vis the legitimacy criteria of 
digital expert collectives.
...
%% But, but, but... this is the best part!
...
% % understand.
% %
% % LF: more soon! Yes, more soon, next iteration, after xmas.
...
%% It is quite obvious this is not the intention here,
%% but the sensibilities of linguistic anthropologists
%% might be triggered by this one as a form of 'mock spanish'
%% I would rather avoid any misunderstanding of that sort
%% Plus, C++ is a commercial language, I think Go is more elegant =)
%% Therefore, more desirable. Don't you think?
...
This form of dualism is no longer sustainable or, for our
purposes, even useful for fieldwork research among collectives of
digital experts: it fails invariably to capture the technical and 
institutional conditions for creating virtual worlds on the one hand, 
and on the other, the feedback mechanism that the virtual sociability 
has over interpersonal and between persons and objects both on and 
off-line.  There are important exceptions---it is difficult to imagine 
a fieldwork situation today that \emph{does not} have any form of 
digital communication or interaction as it is easy to imagine situations 
in which only processes have to be attended to primarily online (mailing-list
discussions, IRC conversations, blog posts, Twitter feeds, bug
trackers, ticket systems, and source code management systems,
etc.). \footnote{See: \cite{BoelstorffandNardi2013} concise and 
  extremely useful handbook on ethnographic studies of virtual worlds 
  in the ironic format of the ``Notes and Queries in Anthropology'' 
  which had many versions since the early development of British 
  Anthropology and was meant to prepare ethnographers to do fieldwork, 
  anticipating topics of inquiry and questions of method. As a side note, 
  one of our senior mentors who did fieldwork in the late 1950's among 
  the Inuit says that it was the only book he brought to the field with 
  him and it was completely useless (personal communication).}
...
has insisted that the distinction has been dissolved---users are (or can
be) experts now.  But this erases distinctions rather than proliferating 
them: what is at stake is a reconfiguration of the relation amongst users 
of technologies and their ability to become proficient in their use, 
institutions that coordinate such learning, and the legitimacy of that knowledge.
